...
바로 위에서 설명한 분류 기준을 설명하듯이, 위의 그림을 보면 N으로 제대로 분류할 확률이 높아 주의란에 대부분의 분포가 몰려있는 것을 확인할 수 있다. 그러나, 그 외 주의나 위험군의 경우 제대로 된 예측을 할 확률이 상대적으로 떨어져 소규모 분포만이 있음을 확인할 수 있다.
